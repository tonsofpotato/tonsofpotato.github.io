...
let DuelingPicklist = _decorate([e$1("dueling-picklistrayse")], function (_initialize, _LitElement) {
  class DuelingPicklist extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  `;
      ...
      kind: "method",
      key: "moveItem",
      value: function moveItem(fromList, toList) {
        ...
        const args = {
          ...
          cancelable: false,
          composed: true,
          detail: this.getRightListValues()
        };
      ...
      <div class="container">
        ...
        <div class="btn-container">
          <button
            id="moveRightBtn"
            @click=${() => this.moveItem(this.shadowRoot?.getElementById("leftList"), this.shadowRoot?.getElementById("rightList"))}
          >
            Move >>
          </button>
          <button
            id="moveLeftBtn"
            @click=${() => this.moveItem(this.shadowRoot?.getElementById("rightList"), this.shadowRoot?.getElementById("leftList"))}
          >
            << Move
          </button>
        </div>
    ...
    `;
      ...
      kind: "method",
      key: "getRightListValues",
      value: function getRightListValues() {
        const rightListOptions = this.shadowRoot?.querySelectorAll("#rightList option");
        if (!rightListOptions) {
          return '';
        }
